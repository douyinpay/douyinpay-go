...
func (a *AppApiService) QueryOrderById(ctx context.Context, req QueryOrderByIdRequest) (resp *partnerpay.Transaction, result *client.APIResult, err error) {
...
func (a *AppApiService) QueryOrderByOutTradeNo(ctx context.Context, req QueryOrderByOutTradeNoRequest) (resp *partnerpay.Transaction, result *client.APIResult, err error) {
