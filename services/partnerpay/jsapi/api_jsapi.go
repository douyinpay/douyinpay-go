...
func (a *JsapiApiService) Prepay(ctx context.Context, req PrepayRequest) (resp *PrepayResponse, result *client.APIResult, err error) {
	...
	r.RequestPath = contractorder.GetServerAddress() + consts.PartnerJsapiPrepayPath
...
// CloseOrder 关闭订单
func (a *JsapiApiService) CloseOrder(ctx context.Context, req CloseOrderRequest) (result *client.APIResult, err error) {
	if req.OutTradeNo == "" {
...
func (a *JsapiApiService) QueryOrderById(ctx context.Context, req QueryOrderByIdRequest) (resp *partnerpay.Transaction, result *client.APIResult, err error) {
...
func (a *JsapiApiService) QueryOrderByOutTradeNo(ctx context.Context, req QueryOrderByOutTradeNoRequest) (resp *partnerpay.Transaction, result *client.APIResult, err error) {
