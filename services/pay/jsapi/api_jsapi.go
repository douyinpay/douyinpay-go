...
func (a *JsapiApiService) Prepay(ctx context.Context, req PrepayRequest) (resp *PrepayResponse, result *client.APIResult, err error) {
	...
	r.RequestPath = consts.DouyinPayServer + consts.JsapiPrepayPath
...
func (a *JsapiApiService) QueryOrderById(ctx context.Context, req QueryOrderByIdRequest) (resp *pay.Transaction, result *client.APIResult, err error) {
...
func (a *JsapiApiService) QueryOrderByOutTradeNo(ctx context.Context, req QueryOrderByOutTradeNoRequest) (resp *pay.Transaction, result *client.APIResult, err error) {
