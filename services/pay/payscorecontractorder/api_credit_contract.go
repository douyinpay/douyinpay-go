...
type CreditContractOrderApiService services.Service

// Prepay 支付中签约下单 支持APP、H5、JSAPI
func (a *CreditContractOrderApiService) Prepay(ctx context.Context, req PrepayRequest) (resp *PrepayResponse, result *client.APIResult, err error) {
	...
	r.RequestPath = consts.DouyinPayServer + consts.CreditContractPrepayPath
...
// CloseOrder 关闭订单
func (a *CreditContractOrderApiService) CloseOrder(ctx context.Context, req CloseOrderRequest) (result *client.APIResult, err error) {
	if req.OutTradeNo == "" {
...
func (a *CreditContractOrderApiService) QueryOrderById(ctx context.Context, req QueryOrderByIdRequest) (resp *pay.Transaction, result *client.APIResult, err error) {
...
func (a *CreditContractOrderApiService) QueryOrderByOutTradeNo(ctx context.Context, req QueryOrderByOutTradeNoRequest) (resp *pay.Transaction, result *client.APIResult, err error) {
